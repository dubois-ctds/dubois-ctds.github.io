...
* **Lab**: Guided active classroom activities autograded[^otter] Jupyter Notebooks. Weekly.
...
Our goal is to make this curriculum as adaptable as possible. Materials were originally developed using the [datascience](https://pypi.org/project/datascience/) Python package as our tabular programming paradigm. We recommend you view these first.

We are in the process of translating a set of extended materials to other APIs:

* [pandas](https://pandas.pydata.org/)
* [polars](https://pola.rs/) for Python
* [tidyverse](https://tidyr.tidyverse.org/) for R
...
See our [home page](/#usage-and-license).